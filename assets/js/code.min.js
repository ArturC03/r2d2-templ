(() => {
  ...
  var Yn = (F, z) => () => (
    z || F((z = { exports: {} }).exports, z), z.exports
  );
  var et = (F, z, V, G) => {
    if ((z && typeof z == "object") || typeof z == "function")
      for (let J of Xn(z))
        !Jn.call(F, J) &&
          ...
          yn(F, J, {
            get: () => z[J],
            enumerable: !(G = Qn(z, J)) || G.enumerable,
          });
    return F;
  };
  var nt = (F, z, V) => (
    ...
    et(
      z || !F || !F.__esModule
        ? yn(V, "default", { value: F, enumerable: !0 })
        : V,
      F,
    )
  );
  var vn = Yn((wn, Ue) => {
    window.hljs = (function () {
      ...
      function F(e) {
        return (
          ...
          Object.getOwnPropertyNames(e).forEach((n) => {
            let t = e[n],
              a = typeof t;
            (a !== "object" && a !== "function") || Object.isFrozen(t) || F(t);
          }),
          e
        );
      }
      ...
      class Q {
        constructor() {
          (this.rootNode = j()), (this.stack = [this.rootNode]);
        }
        get top() {
      ...
      let Ke = "[a-zA-Z]\\w*",
        ...
        pe = (e, n, t = {}) => {
          let a = G({ scope: "comment", begin: e, end: n, contains: [] }, t);
          a.contains.push({
            scope: "doctag",
      ...
      var _e = Object.freeze({
        ...
        APOS_STRING_MODE: xn,
        BACKSLASH_ESCAPE: ue,
        BINARY_NUMBER_MODE: { scope: "number", begin: Ge, relevance: 0 },
        BINARY_NUMBER_RE: Ge,
        COMMENT: pe,
        C_BLOCK_COMMENT_MODE: Mn,
        C_LINE_COMMENT_MODE: On,
        C_NUMBER_MODE: { scope: "number", begin: He, relevance: 0 },
        C_NUMBER_RE: He,
        END_SAME_AS_BEGIN: (e) =>
          Object.assign(e, {
            "on:begin": (n, t) => {
        ...
        HASH_COMMENT_MODE: An,
        IDENT_RE: Ke,
        MATCH_NOTHING_RE: /\b\B/,
        METHOD_GUARD: { begin: "\\.\\s*" + Ae, relevance: 0 },
        NUMBER_MODE: { scope: "number", begin: qe, relevance: 0 },
        NUMBER_RE: qe,
        PHRASAL_WORDS_MODE: {
          begin:
        ...
        REGEXP_MODE: {
          ...
          contains: [
            ue,
            { begin: /\[/, end: /\]/, relevance: 0, contains: [ue] },
          ],
        },
        RE_STARTERS_RE:
          "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",
        SHEBANG: (e = {}) => {
          let n = /^#![ ]*\//;
          return (
            e.binary && (e.begin = N(n, /.*\b/, e.binary, /\b.*/)),
            G(
              {
                scope: "meta",
                begin: n,
        ...
        TITLE_MODE: { scope: "title", begin: Ke, relevance: 0 },
        UNDERSCORE_IDENT_RE: Ae,
        UNDERSCORE_TITLE_MODE: { scope: "title", begin: Ae, relevance: 0 },
      });
      function Sn(e, n) {
      ...
      let Ln = (e, n) => {
          ...
          Object.keys(e).forEach((a) => {
            ...
            (e.begin = N(t.beforeMatch, Y(t.begin))),
            (e.starts = {
              relevance: 0,
          ...
          typeof e == "string"
            ...
            : Array.isArray(e)
              ...
              : Object.keys(e).forEach((i) => {
                  Object.assign(a, Ze(e[i], n, i));
                }),
          a
        );
        function r(i, o) {
          n && (o = o.map((s) => s.toLowerCase())),
            o.forEach((s) => {
              let l = s.split("|");
              a[l[0]] = [i, $n(l[0], l[1])];
            });
      ...
      function $n(e, n) {
        return n ? Number(n) : ((t) => Bn.includes(t.toLowerCase()))(e) ? 0 : 1;
      }
      let We = {},
        re = (e) => {
          console.error(e);
        ...
        he = Error();
      function Xe(e, n, { key: t }) {
        let a = 0,
          r = e[t],
          i = {},
          o = {};
        for (let s = 1; s <= n.length; s++)
          (o[s + a] = r[s]), (i[s + a] = !0), (a += Pe(n[s - 1]));
          ...
          ((n) => {
            if (Array.isArray(n.begin)) {
              ...
              if (typeof n.beginScope != "object" || n.beginScope === null)
                throw (re("beginScope must be object"), he);
              Xe(n, n.begin, { key: "beginScope" }),
                (n.begin = Me(n.begin, { joinWith: "" }));
            }
          })(e),
          ((n) => {
            if (Array.isArray(n.end)) {
              ...
              if (typeof n.endScope != "object" || n.endScope === null)
                throw (re("endScope must be object"), he);
              Xe(n, n.end, { key: "endScope" }),
                (n.end = Me(n.end, { joinWith: "" }));
            }
          })(e);
      }
      function zn(e) {
        ...
        class t {
          ...
          compile() {
            ...
            let i = this.regexes.map((o) => o[1]);
            (this.matcherRe = n(Me(i, { joinWith: "|" }), !0)),
              (this.lastIndex = 0);
          }
          exec(i) {
            this.matcherRe.lastIndex = this.lastIndex;
            let o = this.matcherRe.exec(i);
            if (!o) return null;
            let s = o.findIndex((c, g) => g > 0 && c !== void 0),
              l = this.matchIndexes[s];
            return o.splice(0, s), Object.assign(o, l);
          }
        }
        class a {
          constructor() {
          ...
          getMatcher(i) {
            ...
            let o = new t();
            return (
              this.rules.slice(i).forEach(([s, l]) => o.addRule(s, l)),
              o.compile(),
        ...
        return (
          (e.classNameAliases = G(e.classNameAliases || {})),
          (function r(i, o) {
            let s = i;
            if (i.isCompiled) return s;
            [Cn, Dn, Fn, Ln].forEach((c) => c(i, o)),
              e.compilerExtensions.forEach((c) => c(i, o)),
              (i.__beforeBegin = null),
              [Tn, Rn, In].forEach((c) => c(i, o)),
              (i.isCompiled = !0);
            let l = null;
            return (
              ...
              (l = l || /\w+/),
              i.keywords && (i.keywords = Ze(i.keywords, e.case_insensitive)),
              (s.keywordPatternRe = n(l, !0)),
              o &&
                (i.begin || (i.begin = /\B|\b/),
                (s.beginRe = n(s.begin)),
                i.end || i.endsWithParent || (i.end = /\B|\b/),
                i.end && (s.endRe = n(s.end)),
                (s.terminatorEnd = W(s.end) || ""),
                i.endsWithParent &&
                  o.terminatorEnd &&
                  (s.terminatorEnd += (i.end ? "|" : "") + o.terminatorEnd)),
              ...
              (i.contains = [].concat(
                ...i.contains.map((c) =>
                  ((g) => (
                    g.variants &&
                      !g.cachedVariants &&
                      (g.cachedVariants = g.variants.map((p) =>
                        G(g, { variants: null }, p),
                      )),
                    g.cachedVariants
                      ? g.cachedVariants
                      : Ve(g)
                        ? G(g, { starts: g.starts ? G(g.starts) : null })
                        : Object.isFrozen(g)
                          ? G(g)
                          : g
                  ))(c === "self" ? i : c),
              ...
              (s.matcher = ((c) => {
                let g = new a();
                return (
                  c.contains.forEach((p) =>
                    g.addRule(p.begin, { rule: p, type: "begin" }),
                  ),
                  c.terminatorEnd &&
                    g.addRule(c.terminatorEnd, { type: "end" }),
                  c.illegal && g.addRule(c.illegal, { type: "illegal" }),
                  g
                );
              })(s)),
              s
      ...
      function Ve(e) {
        return !!e && (e.endsWithParent || Ve(e.starts));
      }
      ...
      let Se = V,
        ...
        en = (e) => {
          ...
          function l(d) {
            return s.noHighlightRe.test(d);
          }
          function c(d, m, h) {
            let D = "",
              C = "";
            typeof m == "object"
              ? ((D = d), (h = m.ignoreIllegals), (C = m.language))
              : (ce(
                  "10.7.0",
...
https://github.com/highlightjs/highlight.js/issues/2277`,
                ...
                (D = m)),
              h === void 0 && (h = !0);
            let A = { code: D, language: C };
            $("before:highlight", A);
            let k = A.result ? A.result : g(A.language, A.code, h);
            return (k.code = A.code), $("after:highlight", k), k;
          }
          function g(d, m, h, D) {
            let C = Object.create(null);
            function A() {
              if (!f.keywords) return void E.addText(M);
              let u = 0;
              f.keywordPatternRe.lastIndex = 0;
              let _ = f.keywordPatternRe.exec(M),
                T = "";
              for (; _; ) {
                T += M.substring(u, _.index);
                let I = H.case_insensitive ? _[0].toLowerCase() : _[0],
                  P = ((S = I), f.keywords[S]);
                if (P) {
                  let [ae, je] = P;
                  if (
                    ...
                    let Oe = H.classNameAliases[ae] || ae;
                    O(_[0], Oe);
                  }
                } else T += _[0];
                (u = f.keywordPatternRe.lastIndex),
                  (_ = f.keywordPatternRe.exec(M));
              }
              var S;
              (T += M.substring(u)), E.addText(T);
            }
            function k() {
              f.subLanguage != null
                ? (() => {
                    ...
                    if (typeof f.subLanguage == "string") {
                      if (!n[f.subLanguage]) return void E.addText(M);
                      (u = g(f.subLanguage, M, !0, ke[f.subLanguage])),
                        (ke[f.subLanguage] = u._top);
                    } else
                      u = p(M, f.subLanguage.length ? f.subLanguage : null);
                    f.relevance > 0 && (ne += u.relevance),
                      E.__addSublanguage(u._emitter, u.language);
                  })()
                : A(),
                (M = "");
            }
            function O(u, _) {
              u !== "" && (E.startScope(_), E.addText(u), E.endScope());
            }
            function x(u, _) {
              let T = 1,
                S = _.length - 1;
              for (; T <= S; ) {
                ...
                let I = H.classNameAliases[u[T]] || u[T],
                  P = _[T];
                I ? O(P, I) : ((M = P), A(), (M = "")), T++;
              }
            }
            function L(u, _) {
              return (
                u.scope &&
                  ...
                  E.openNode(H.classNameAliases[u.scope] || u.scope),
                u.beginScope &&
                  (u.beginScope._wrap
                    ? (O(
                        M,
                        H.classNameAliases[u.beginScope._wrap] ||
                          u.beginScope._wrap,
                      ),
                      (M = ""))
                    : u.beginScope._multi && (x(u.beginScope, _), (M = ""))),
                (f = Object.create(u, { parent: { value: f } })),
                f
              );
            }
            function Z(u, _, T) {
              let S = ((I, P) => {
                let ae = I && I.exec(P);
                return ae && ae.index === 0;
              })(u.endRe, T);
              if (S) {
                if (u["on:end"]) {
                  let I = new z(u);
                  u["on:end"](_, I), I.isMatchIgnored && (S = !1);
                }
                if (S) {
              ...
              if (u.endsWithParent) return Z(u.parent, _, T);
            }
            function oe(u) {
              return f.matcher.regexIndex === 0
                ? ((M += u[0]), 1)
                : ((ze = !0), 0);
            }
            function ie(u) {
              let _ = u[0],
                T = m.substring(u.index),
                S = Z(f, u, T);
              if (!S) return Ye;
              let I = f;
              f.endScope && f.endScope._wrap
                ? (k(), O(_, f.endScope._wrap))
                : f.endScope && f.endScope._multi
                  ? (k(), x(f.endScope, u))
                  : I.skip
                    ? (M += _)
                    : (I.returnEnd || I.excludeEnd || (M += _),
                      k(),
                      I.excludeEnd && (M = _));
              do
                f.scope && E.closeNode(),
                  f.skip || f.subLanguage || (ne += f.relevance),
                  (f = f.parent);
              while (f !== S.parent);
              return S.starts && L(S.starts, u), I.returnEnd ? 0 : _.length;
            }
            let X = {};
            function se(u, _) {
              let T = _ && _[0];
              if (((M += u), T == null)) return k(), 0;
              if (
                X.type === "begin" &&
                _.type === "end" &&
                X.index === _.index &&
                ...
                if (((M += m.slice(_.index, _.index + 1)), !r)) {
                  let S = Error(`0 width match regex (${d})`);
                  throw ((S.languageName = d), (S.badRule = X.rule), S);
                }
                return 1;
              }
              if (((X = _), _.type === "begin"))
                return ((S) => {
                  let I = S[0],
                    P = S.rule,
                    ae = new z(P),
                    je = [P.__beforeBegin, P["on:begin"]];
                  for (let Oe of je)
                    if (Oe && (Oe(S, ae), ae.isMatchIgnored)) return oe(I);
                  return (
                    P.skip
                      ? (M += I)
                      : (P.excludeBegin && (M += I),
                        k(),
                        P.returnBegin || P.excludeBegin || (M = I)),
                    L(P, S),
                    P.returnBegin ? 0 : I.length
                  );
                })(_);
              if (_.type === "illegal" && !h) {
                let S = Error(
...
`),
            ...
            if (!H)
              throw (
                (re(i.replace("{}", d)), Error('Unknown language: "' + d + '"'))
              );
            let be = zn(H),
              le = "",
              f = D || be,
            ...
            (() => {
              let u = [];
              for (let _ = f; _ !== H; _ = _.parent)
                _.scope && u.unshift(_.scope);
              u.forEach((_) => E.openNode(_));
            })();
            let M = "",
              ne = 0,
              te = 0,
              ...
              ze = !1;
            try {
              if (H.__emitTokens) H.__emitTokens(m, E);
              else {
                for (f.matcher.considerAll(); ; ) {
                  Fe++,
                    ze ? (ze = !1) : f.matcher.considerAll(),
                    (f.matcher.lastIndex = te);
                  let u = f.matcher.exec(m);
                  if (!u) break;
                  let _ = se(m.substring(te, u.index), u);
                  te = u.index + _;
                }
                se(m.substring(te));
              }
          ...
          function p(d, m) {
            ...
            D.unshift(h);
            let C = D.sort((x, L) => {
                if (x.relevance !== L.relevance)
                  return L.relevance - x.relevance;
                if (x.language && L.language) {
                  if (v(x.language).supersetOf === L.language) return 1;
                  if (v(L.language).supersetOf === x.language) return -1;
                }
                return 0;
              }),
              [A, k] = C,
              O = A;
            return (O.secondBest = k), O;
          }
          function b(d) {
            let m = null,
              h = ((A) => {
                let k = A.className + " ";
                k += A.parentNode ? A.parentNode.className : "";
                let O = s.languageDetectRe.exec(k);
                if (O) {
                  let x = v(O[1]);
                  return (
                    x ||
                ...
                return k.split(/\s+/).find((x) => l(x) || v(x));
              })(d);
            if (l(h)) return;
            if (
              ($("before:highlightElement", { el: d, language: h }),
            ...
            m = d;
            let D = m.textContent,
              C = h ? c(D, { language: h, ignoreIllegals: !0 }) : p(D);
            (d.innerHTML = C.value),
              (d.dataset.highlighted = "yes"),
              ((A, k, O) => {
                let x = (k && t[k]) || O;
                A.classList.add("hljs"), A.classList.add("language-" + x);
              })(d, h, C.language),
              (d.result = {
                language: C.language,
                re: C.relevance,
              ...
              $("after:highlightElement", { el: d, result: C, text: D });
          }
          let y = !1;
          function w() {
            ...
            document.querySelectorAll(s.cssSelector).forEach(b);
          }
          function v(d) {
            return (d = (d || "").toLowerCase()), n[d] || n[t[d]];
          }
          function R(d, { languageName: m }) {
            typeof d == "string" && (d = [d]),
              d.forEach((h) => {
                t[h.toLowerCase()] = m;
              });
          ...
          Object.assign(e, {
            ...
            highlightElement: b,
            highlightBlock: (d) => (
              ce("10.7.0", "highlightBlock will be removed entirely in v12.0"),
              ce("10.7.0", "Please use highlightElement now."),
              b(d)
            ),
            configure: (d) => {
              s = Je(s, d);
            ...
            registerLanguage: (d, m) => {
              ...
              h.name || (h.name = d),
                (n[d] = h),
                (h.rawDefinition = m.bind(null, e)),
                h.aliases && R(h.aliases, { languageName: d });
            },
            unregisterLanguage: (d) => {
              delete n[d];
              for (let m of Object.keys(t)) t[m] === d && delete t[m];
            },
          ...
          for (let d in _e) typeof _e[d] == "object" && F(_e[d]);
      ...
      var de = "[0-9](_*[0-9])*",
        ...
        Ie = {
          ...
          variants: [
            ...
            { begin: `\\b(${de})[fFdD]\\b` },
            {
              begin: `\\b0[xX]((${we})\\.?|(${we})?\\.(${we}))[pP][+-]?(${de})[fFdD]?\\b`,
            },
      ...
      let ve = "[A-Za-z$_][0-9A-Za-z$_]*",
        ...
        sn = ["true", "false", "null", "undefined", "NaN", "Infinity"],
        rn = [
          "Object",
          "Function",
          "Boolean",
      ...
      function gn(e) {
        let n = e.regex,
          ...
          a = {
            ...
            isTrulyOpeningTag: (L, Z) => {
              let oe = L[0].length + L.index,
                ie = L.input[oe];
              if (ie === "<" || ie === ",") return void Z.ignoreMatch();
              let X;
              ie === ">" &&
                (((H, { after: be }) => {
                  let le = "</" + H[0].slice(1);
                  return H.input.indexOf(le, be) !== -1;
                })(L, { after: oe }) ||
                  Z.ignoreMatch());
              let se = L.input.substring(oe);
              ((X = se.match(/^\s*=/)) ||
                ((X = se.match(/^\s+extends\s+/)) && X.index === 0)) &&
                Z.ignoreMatch();
            },
          },
          r = {
        ...
        return {
          ...
          keywords: r,
          exports: { PARAMS_CONTAINS: q, CLASS_REFERENCE: m },
          illegal: /#(?![$_A-z])/,
          contains: [
      ...
      let Le = (e) => N(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
        Pn = ["Protocol", "Type"].map(Le),
        un = ["init", "self"].map(Le),
        Kn = ["Any", "Self"],
        Be = [
          "actor",
      ...
      var fn = Object.freeze({
        ...
        grmr_c: (e) => {
          let n = e.regex,
            ...
            y = [c, o, t, e.C_BLOCK_COMMENT_MODE, l, s],
            w = {
              variants: [
                { begin: /=/, end: /;/ },
                { begin: /\(/, end: /\)/ },
                ...
                { relevance: 0, match: /,/ },
                {
                  ...
                  contains: [
                    ...
                    o,
                    {
                      ...
                      keywords: b,
                      relevance: 0,
                      contains: ["self", t, e.C_BLOCK_COMMENT_MODE, s, l, o],
                    },
                  ],
                },
                o,
          ...
          return {
            ...
            exports: { preprocessor: c, strings: s, keywords: b },
          };
        },
        grmr_cpp: (e) => {
          let n = e.regex,
            ...
            w = [y, c, o, t, e.C_BLOCK_COMMENT_MODE, l, s],
            v = {
              variants: [
                { begin: /=/, end: /;/ },
                { begin: /\(/, end: /\)/ },
            ...
            R = {
              ...
              contains: [
                { begin: a, keywords: b, relevance: 0 },
                { begin: p, returnBegin: !0, contains: [g], relevance: 0 },
                { begin: /::/, relevance: 0 },
          ...
          return {
            ...
            contains: [
              ...
              },
              {
                ...
                illegal: /[^\s:]/,
                contains: [t, b, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
              },
              {
                className: "meta",
                begin: "^\\s*\\[(?=[\\w])",
        ...
        grmr_css: (e) => {
          ...
          return {
            ...
            contains: [
              ...
              t.CSS_VARIABLE,
              { className: "attribute", begin: "\\b(" + De.join("|") + ")\\b" },
              {
                begin: /:/,
                end: /[;}{]/,
                contains: [
          ...
          return {
            ...
            contains: [
              ...
              { className: "section", begin: /\[+/, end: /\]+/ },
              {
                ...
                className: "attr",
                starts: { end: /$/, contains: [a, s, i, r, o, t] },
              },
            ],
          };
        },
        ...
        grmr_kotlin: (e) => {
          ...
          let o = {
            ...
            p = g;
          return (
            (p.variants[1].contains = [g]),
            (g.variants[1].contains = [p]),
            {
              name: "Kotlin",
              aliases: ["kt", "kts"],
              keywords: n,
...
`,
        ...
        grmr_less: (e) => {
          let n = Ce(e),
            ...
            i = [],
            o = [],
            s = ($) => ({ className: "string", begin: "~?" + $ + ".*?" + $ }),
            l = ($, d, m) => ({ className: $, begin: d, relevance: m }),
            c = {
              $pattern: /[a-z-]+/,
              keyword: "and or not only",
              attribute: Re.join(" "),
          ...
          let p = o.concat({ begin: /\{/, end: /\}/, contains: i }),
            b = {
              beginKeywords: "when",
              endsWithParent: !0,
        ...
        grmr_markdown: (e) => {
          ...
          a.contains.push(o), r.contains.push(i);
          let s = [n, t];
          return (
            [a, r, i, o].forEach((l) => {
        ...
        grmr_perl: (e) => {
          ...
          return (
            (r.contains = y),
            (i.contains = y),
            { name: "Perl", aliases: ["pl", "pm"], keywords: a, contains: y }
          );
        },
        grmr_php: (e) => {
          let n = e.regex,
            ...
            g = {
              ...
              variants: [
                ...
                l,
                {
                  ...
                  contains: e.QUOTE_STRING_MODE.contains.concat(s),
                  "on:begin": (k, O) => {
                    O.data._beginMatch = k[1] || k[2];
                  },
                  "on:end": (k, O) => {
                    O.data._beginMatch !== k[1] && O.ignoreMatch();
                  },
                },
                e.END_SAME_AS_BEGIN({
                  begin: /<<<[ \t]*'(\w+)'\n/,
              ...
              literal: ((k) => {
                ...
                return (
                  k.forEach((x) => {
                    O.push(x),
                      x.toLowerCase() === x
                        ? O.push(x.toUpperCase())
                        : O.push(x.toLowerCase());
                  }),
                  O
                );
              })(b),
            ...
            d = {
              variants: [
                {
                  match: [n.concat(/::/, n.lookahead(/(?!class\b)/)), $],
                  scope: { 2: "variable.constant" },
                },
                { match: [/::/, /class/], scope: { 2: "variable.language" } },
                {
                  match: [r, n.concat(/::/, n.lookahead(/(?!class\b)/)), $],
            ...
            h = {
              ...
              keywords: v,
              contains: [m, o, d, e.C_BLOCK_COMMENT_MODE, g, p, q],
            },
            D = {
              relevance: 0,
              match: [
          ...
          h.contains.push(D);
          let C = [m, d, e.C_BLOCK_COMMENT_MODE, g, p, q],
            A = {
              begin: n.concat(/#\[\s*\\?/, n.either(r, i)),
              beginScope: "meta",
              end: /]/,
              endScope: "meta",
              ...
              q,
              {
                ...
                contains: [
                  ...
                  { begin: "=>", endsParent: !0 },
                  {
                    ...
                    excludeEnd: !0,
                    keywords: v,
                    contains: ["self", A, o, d, e.C_BLOCK_COMMENT_MODE, g, p],
                  },
                ],
              },
              {
            ...
            l = {
              ...
              variants: [
                ...
                },
                {
                  ...
                  contains: [e.BACKSLASH_ESCAPE, i, s, o],
                },
                {
                  begin: /([fF][rR]|[rR][fF]|[fF])"""/,
                  end: /"""/,
            ...
            w = {
              ...
              variants: [
                { className: "", begin: /\(\s*\)/, skip: !0 },
                {
                  ...
                  excludeEnd: !0,
                  keywords: r,
                  contains: ["self", i, b, l, e.HASH_COMMENT_MODE],
                },
              ],
            };
          return (
            ...
            contains: [
              ...
              },
              {
                ...
                variants: [
                  ...
                  { scope: { 1: "punctuation", 2: "number" }, match: [i, a] },
        ...
        grmr_ruby: (e) => {
          ...
          (c.contains = w), (y.contains = w);
          let v = [
            { begin: /^\s*=>/, starts: { end: "$", contains: w } },
            {
              className: "meta.prompt",
              begin:
                "^([>?]>|[\\w#]+\\(\\w+\\):\\d+:\\d+[>*]|(\\w+-)?\\d+\\.\\d+\\.\\d+(p\\d+)?[^\\d][^>]+>)(?=[ ])",
              starts: { end: "$", keywords: i, contains: w },
            },
          ];
          return (
            l.unshift(s),
        ...
        grmr_sql: (e) => {
          ...
          function s(c) {
            return n.concat(
              /\b/,
              n.either(...c.map((g) => g.replace(/\s+/, "\\s+"))),
              /\b/,
            );
          }
          let l = {
          ...
          return {
            ...
            keywords: {
              $pattern: /\b[\w\.]+/,
              keyword: ((c, { exceptions: g, when: p } = {}) => {
                let b = p;
                return (
                  (g = g || []),
                  c.map((y) =>
                    y.match(/\|\d+$/) || g.includes(y)
                      ? y
                      : b(y)
                        ? y + "|0"
                        : y,
        ...
        grmr_swift: (e) => {
          let n = { match: /\s+/, relevance: 0 },
            ...
            r = { match: [/\./, U(...Pn, ...un)], className: { 2: "keyword" } },
            i = { match: N(/\./, U(...Be)), relevance: 0 },
            o = Be.filter((E) => typeof E == "string").concat(["_|0"]),
            s = {
              variants: [
                {
                  className: "keyword",
                  match: U(
                    ...Be.filter((E) => typeof E != "string")
                      .concat(Kn)
                      .map(Le),
                    ...un,
                  ),
            ...
            c = [r, i, s],
            g = [
              { match: N(/\./, U(...mn)), relevance: 0 },
              { className: "built_in", match: N(/\b/, U(...mn), /(?=\()/) },
            ],
            p = { match: /->/, relevance: 0 },
            b = [
              p,
            ...
            A = (E) => {
              ...
              return {
                ...
                contains: [
                  ...D,
                  { scope: "comment", begin: `#(?!.*${ne})`, end: /$/ },
                ],
              };
            },
            k = { scope: "regexp", variants: [A("###"), A("##"), A("#"), C] },
            O = { match: N(/`/, ee, /`/) },
            x = [
              O,
              { className: "variable", match: /\$\d+/ },
              { className: "variable", match: `\\$${Ne}+` },
            ],
            L = [
              {
                match: /(@|#(un)?)available/,
              ...
              { scope: "keyword", match: N(/@/, U(...Gn), Y(U(/\(/, /\s+/))) },
              { scope: "meta", match: N(/@/, ee) },
            ],
            Z = {
              match: Y(/\b[A-Z]/),
              relevance: 0,
              contains: [
                ...
                { className: "type", match: xe, relevance: 0 },
                { match: /[?!]+/, relevance: 0 },
                { match: /\.\.\./, relevance: 0 },
                { match: N(/\s+&\s+/, Y(xe)), relevance: 0 },
              ],
            },
            oe = {
              begin: /</,
          ...
          let ie = {
              ...
              contains: [
                "self",
                { match: N(ee, /\s*:/), keywords: "_|0", relevance: 0 },
                ...a,
                k,
                ...c,
                ...g,
            ...
            se = {
              ...
              contains: [
                {
                  begin: U(Y(N(ee, /\s*:/)), Y(N(ee, /\s+/, ee, /\s*:/))),
                  end: /:/,
                  relevance: 0,
                  contains: [
                    { className: "keyword", match: /\b_\b/ },
                    { className: "params", match: ee },
                  ],
                },
                ...a,
                ...c,
            ...
            H = {
              match: [/(func|macro)/, /\s+/, U(O.match, ee, $e)],
              className: { 1: "keyword", 3: "title.function" },
              contains: [X, se, n],
              illegal: [/\[/, /%/],
            },
            ...
            ke = {
              ...
              contains: [
                ...
                ...c,
                {
                  ...
                  keywords: l,
                  contains: [
                    { scope: "title.class.inherited", match: xe },
                    ...c,
                  ],
                  relevance: 0,
                },
          ...
          for (let E of h.variants) {
            let M = E.contains.find((te) => te.label === "interpol");
            M.keywords = l;
            let ne = [...c, ...g, ...b, v, h, ...x];
            M.contains = [
              ...ne,
              { begin: /\(/, end: /\)/, contains: ["self", ...ne] },
            ];
          }
          return {
            name: "Swift",
        ...
        grmr_typescript: (e) => {
          let n = e.regex,
            ...
            s = {
              ...
              literal: sn,
              built_in: dn.concat(r),
              "variable.language": cn,
            },
            l = { className: "meta", begin: "@" + a },
            c = (b, y, w) => {
              let v = b.contains.findIndex((R) => R.label === y);
              if (v === -1) throw Error("can not find mode to replace");
              b.contains.splice(v, 1, w);
            };
          Object.assign(t.keywords, s), t.exports.PARAMS_CONTAINS.push(l);
          let g = t.contains.find((b) => b.scope === "attr"),
            p = Object.assign({}, g, {
              match: n.concat(a, n.lookahead(/\s*\?:/)),
            });
          return (
            t.exports.PARAMS_CONTAINS.push([t.exports.CLASS_REFERENCE, g, p]),
            (t.contains = t.contains.concat([l, i, o, p])),
            ...
            (t.contains.find((b) => b.label === "func.def").relevance = 0),
            Object.assign(t, {
              name: "TypeScript",
      ...
      let En = nn;
      for (let e of Object.keys(fn)) {
        let n = e.replace("grmr_", "").replace("_", "-");
        En.registerLanguage(n, fn[e]);
      }
      return En;
    })();
    typeof wn == "object" && typeof Ue < "u" && (Ue.exports = hljs);
  });
  var at = nt(vn());
  (function () {
    function F(B, j = 1) {
    ...
    function z(B, j, Q) {
      ...
      try {
        document.execCommand("copy") &&
          ...
          setTimeout(() => {
            (j.style.display = "none"), (Q.style.display = "inline");
          }, 2e3));
      } catch (W) {
    ...
    function V(B) {
      if (!B || B._codeInitialized) return;
      let j = B.querySelector("[data-code-block]"),
        Q = B.querySelector("[data-copy-button]"),
        K = B.querySelector("[data-icon-check]"),
        W = B.querySelector("[data-icon-clipboard]");
      if (
        (j &&
          window.hljs &&
          (j.classList.contains("hljs") || window.hljs.highlightElement(j)),
        Q && j && K && W)
      ) {
        let Y = Q._copyListener;
        Y && Q.removeEventListener("click", Y);
        let me = () => {
          let ge = j.textContent || "",
            N = () => {
              (K.style.display = "inline"),
                (W.style.display = "none"),
                setTimeout(() => {
                  (K.style.display = "none"), (W.style.display = "inline");
                }, 2e3);
            };
        ...
        Q.addEventListener("click", me), (Q._copyListener = me);
      }
      B._codeInitialized = !0;
    }
    function G(B = document) {
      B instanceof Element && B.matches("[data-code-component]") && V(B);
      for (let j of B.querySelectorAll("[data-code-component]")) V(j);
    }
    let J = (B) => {
      let j = B.detail.target || B.detail.elt;
      j instanceof Element && F(() => G(j));
    };
    document.addEventListener("DOMContentLoaded", () => {
      F(() => G());
    }),
      document.body.addEventListener("htmx:afterSwap", J),
      document.body.addEventListener("htmx:oobAfterSwap", J);
  })();
})();
/*!
